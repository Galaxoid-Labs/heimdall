...
// main.odin references ASSETS (defined in the generated assets_gen.odin, which
// only `heimdall build` produces). Write an empty stub so dev builds compile;
// dev uses dev_url and ignores assets anyway.
@(private = "file")
ensure_assets_stub :: proc(p: Project) {
	if file_exists("assets_gen.odin") {
		return
	}
	src := fmt.tprintf(
		"#+feature dynamic-literals\n// Code generated by `heimdall dev` (stub). DO NOT EDIT.\npackage main\n\nimport hd \"%s\"\n\nASSETS := map[string]hd.Asset {{}}\n",
		p.import_path,
	)
	_ = os.write_entire_file("assets_gen.odin", transmute([]u8)src)
}
